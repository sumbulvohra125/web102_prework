...
const displayStr = `A total of $${totalRaised.toLocaleString("en-US")} has been raised for 4 games.` +
                    `Currently, ${totalUnfundedGames > 0 ? `${totalUnfundedGames} game${totalUnfundedGames > 1 ? "s" : ""} remain${totalUnfundedGames > 1 ? "" : "s"} unfunded` : "all games are funded"}. ` +
